...
Summary
The logistic regression model showed strong performance for predicting healthy loans but struggled significantly to identify high-risk loans. This is likely due to a class imbalance, where the number of 0s (healthy loans) far exceeds the number of 1s (high-risk loans).
